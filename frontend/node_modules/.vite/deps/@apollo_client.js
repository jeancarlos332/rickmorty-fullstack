...
var { toString: toString4, hasOwnProperty: hasOwnProperty6 } = Object.prototype;
                ...
                return asyncMap(self2.getObservableFromLink(mutation, __assign(__assign({}, context), { optimisticResponse: isOptimistic ? optimisticResponse : void 0 }), variables, {}, false), function(result2) {
                  ...
                  next: function(storeResult) {
                    ...
                    if (!("hasNext" in storeResult) || storeResult.hasNext === false) {
                      resolve4(__assign(__assign({}, storeResult), { data: self2.maskOperation({
                        document: mutation,
...
function executeQuery(resultData, observable, client, currentQuery, options, onQueryExecuted) {
  ...
  return new Promise(function(resolve4) {
    ...
    concast.subscribe({
      ...
      error: function() {
        resolve4(toQueryResult(observable.getCurrentResult(), resultData.previousData, observable, client));
      },
      complete: function() {
        resolve4(toQueryResult(observable["maskResult"](result2), resultData.previousData, observable, client));
      }
    });
  });
}
